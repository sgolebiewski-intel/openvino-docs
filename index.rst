...
.. meta::
   ...
   :description: OpenVINO™ is an open-source toolkit that can be used to 
                 optimize and deploy AI inference.
   :keywords: OpenVINO™, OpenVINO toolkit, open-source, AI, AI inference, 
              optimize AI, optimize inference, deploy inference, deep learning, 
              computer vision, speech recognition, natural language processing, 
              Intel® platform, OpenVINO workflow, Open Model Zoo, Model 
              Optimizer, OpenVINO Runtime, DL Workbench, inference, model 
              inference, neural networks, benchmark
      ...
      <div style="clear:both;"> </div>
        ...
        <p></p>
         ...
         <p>Check the full range of supported hardware in the
            <a href="pages/documentation/openvino-runtime-user-guide/working-with-devices.html"> Supported Devices page</a> and see how it stacks up in our
            <a href="pages/documentation/performance-benchmarks.html"> Performance Benchmarks page.</a> <br>
        Supports deployment on Windows, Linux, and macOS.
         ...
         <div id="HP_flow-container">
   		   <div class="HP_flow-btn">
   	   		<a href="pages/documentation/model-processing.html">
   	   	...
   	   	<div class="HP_flow-btn">
   	   		<a href="pages/documentation/performance-optimization.html">
   	   	...
   	   	<div class="HP_flow-btn">
   	   		<a href="pages/documentation/openvino-deployment-introduction.html">
        ...
        <a href="model_zoo.html">
           ...
           <p> Browse through over 200 publicly available neural networks and pick the right one for your solution. </p>
            ...
            <a href="pages/documentation/converting-models-with-model-optimizer.html">
        ...
        <a href="pages/documentation/performance-benchmarks.html">
